                ...
                <div key={mentor.id} className="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 hover:shadow-md transition-shadow group flex flex-col h-full">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 bg-slate-900 rounded-2xl flex items-center justify-center text-white text-2xl font-black shadow-inner">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-slate-900 flex items-center gap-1">
                          {mentor.full_name || 'Mentor Anonim'}
                          <ShieldCheck className="w-4 h-4 text-blue-500" />
                        </h3>
                        <p className="text-xs font-black text-slate-400 uppercase tracking-wider">{mentor.university || 'Universitas'}</p>
                      </div>
                    </div>
